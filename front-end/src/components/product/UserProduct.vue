  ...
  <div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      <div class="text-center">
        <img :src="diningImage" alt="Dining" class="w-full h-48 object-cover mb-4 rounded-lg shadow-md">
        <h3 class="text-xl font-semibold text-gray-800">Dining</h3>
      </div>
      <div class="text-center">
        <img :src="livingImage" alt="Living" class="w-full h-48 object-cover mb-4 rounded-lg shadow-md">
        <h3 class="text-xl font-semibold text-gray-800">Living</h3>
      </div>
      <div class="text-center">
        <img :src="bedroomImage" alt="Bedroom" class="w-full h-48 object-cover mb-4 rounded-lg shadow-md">
      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mx-12">
          <div
            ...
            :key="product.id"
            class="bg-white rounded-lg shadow-md cursor-pointer relative product-box transition-transform transform hover:scale-105"
...
export default {
  data() {
    return {
      ...
      currentPage: 0,
      itemsPerPage: 8, // Update itemsPerPage to 8 for eight items per row
      activeCategory: 'all',
    };
  },
  computed: {
    paginatedProducts() {
      ...
      return filteredProducts.slice(start, start + this.itemsPerPage);
    },
    maxPage() {
